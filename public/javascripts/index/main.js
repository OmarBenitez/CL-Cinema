...
$(function() {
    $('.single-project .cd-title').each(function(i) {
        console.log($(this).attr("data-url"))
        document.styleSheets[1].addRule('.single-project:nth-of-type(' + (i + 1) + ') .cd-title::before {background-image: url(' + $(this).attr("data-url") + ');')
    });
});